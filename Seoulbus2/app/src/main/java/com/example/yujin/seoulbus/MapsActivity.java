package com.example.yujin.seoulbus;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        /////(1) Bus Route ID /////
        String serviceUrl = "http://ws.bus.go.kr/api/rest/buspos/getBusPosByRouteSt";
        String serviceKey = "qWl0whozSAvcsXLqguahRrZfRvs6JIAbZbPPbXzFK1gv8iOEaWWfZ4xHj7UqnhL2MWYo%2B%2B8FBNSmxjv5qL72jA%3D%3D";
        String strSrch = "406";
        String strUrl = "http://ws.bus.go.kr/api/rest/buspos/getBusPosByRouteSt"+"?ServiceKey="+"qWl0whozSAvcsXLqguahRrZfRvs6JIAbZbPPbXzFK1gv8iOEaWWfZ4xHj7UqnhL2MWYo%2B%2B8FBNSmxjv5qL72jA%3D%3D"+"&strSrch="+13;
    ...
    protected void onPostExecute(String result)  {
        ...
        String serviceKey = "qWl0whozSAvcsXLqguahRrZfRvs6JIAbZbPPbXzFK1gv8iOEaWWfZ4xHj7UqnhL2MWYo%2B%2B8FBNSmxjv5qL72jA%3D%3D";
        String strUrl = "http://ws.bus.go.kr/api/rest/buspos/getBusPosByRtid"+"?ServiceKey="+"qWl0whozSAvcsXLqguahRrZfRvs6JIAbZbPPbXzFK1gv8iOEaWWfZ4xHj7UqnhL2MWYo%2B%2B8FBNSmxjv5qL72jA%3D%3D"+"&busRouteId="+"100100118&startOrd=1&endOrd=15";
